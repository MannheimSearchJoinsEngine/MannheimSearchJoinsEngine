...
public abstract class DataStorageUtils2<T, U> {
	...
	{
		DataStorageUtils2<Object, Object> dsu = new DataStorageUtils2<Object, Object>() {

			@Override
			public Map<Object, Collection<Object>> createMapCollection() {
				return null;
			}

			@Override
			public Collection<Object> createCollection2() {
				return null;
			}

			@Override
			public Object createValueFromString1(String value) {
				return null;
			}

			@Override
			public Object createValueFromString2(String value) {
				return null;
			}

			@Override
			public Collection<Pair<Object, Object>> createPairCollection() {
				return null;
			}
		};
